...
export const initialProducts = [
  {
    ...
    features: [
      ...
      'Includes signature PURE MART velvet dust bag',
...
export const reviewsList = [
  {
    ...
    content: 'PURE MART is my go-to for accent fashion pieces. The pink luxury packaging alone makes opening every order feel like a special event!',
...
export const initialOrders = [
  {
    ...
    date: '2026-07-23',
    items: [
      { id: 'prod-1', name: 'Bella Rose Quilted Crossbody Bag', price: 12500, quantity: 1, color: 'Dusty Rose', image: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?auto=format&fit=crop&w=800&q=80' },
      { id: 'prod-2', name: 'Aura 18K Gold Pearl Drop Earrings', price: 4500, quantity: 1, color: 'Pearl Gold', image: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?auto=format&fit=crop&w=800&q=80' }
    ],
    subtotal: 17000,
    discount: 1700,
    shipping: 0,
  ...
  },
  {
    ...
    date: '2026-07-24',
    items: [
      { id: 'prod-4', name: 'Elixir de Rose Eau de Parfum (100ml)', price: 8500, quantity: 1, color: 'Crystal Pink', image: 'https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=800&q=80' }
    ],
    subtotal: 8500,
    discount: 0,
    shipping: 200,
